...
As shown in the visual comparison, the baseline DRCT often suffers from blur or artifacts under severe sensor noise. In contrast, by incorporating the restoration-oriented structural prior via SFT modulation, our model successfully reconstructs fine details, sharp edges, and clean textures that closely align with the Ground Truth reference.
