...
def main():
    ...
    # HR images
    opt['input_folder'] = '/datasets/RealESRGAN_data/dataset/train/HR'
    opt['save_folder'] = '/datasets/RealESRGAN_data/dataset/train/HR_sub'
    opt['crop_size'] = 480
    opt['step'] = 240
    opt['thresh_size'] = 0
...
def worker(path, opt):
    ...
    # Optional cleanup if filename has scaling tag
