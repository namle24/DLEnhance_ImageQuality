...
class RealESRGANModelStudent(SRGANModel):
    ...
    def __init__(self, opt):
        super(RealESRGANModelStudent, self).__init__(opt)
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        self.is_train = False
        super(RealESRGANModelStudent, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
